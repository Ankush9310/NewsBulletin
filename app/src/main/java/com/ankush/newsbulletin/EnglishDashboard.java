...
public class EnglishDashboard extends AppCompatActivity {
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_dashboard);
...
*/
        ...
        btn4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent webviewIntent = new Intent(EnglishDashboard.this,LoadActivity.class);
